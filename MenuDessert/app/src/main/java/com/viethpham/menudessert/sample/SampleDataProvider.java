package com.viethpham.menudessert.sample;
...
public class SampleDataProvider
{
    ...
    static
    {
        dataItemList = new ArrayList<>(); // ArrayList class is a concrete implementation of the List interface
        dataItemMap  = new HashMap<>();   // HashMap class is a concrete implementation of the Map interface
